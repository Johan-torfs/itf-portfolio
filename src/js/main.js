...
import { startScrollManager, lockTouchScrolling, unlockTouchScrolling, registerOnScrollCallback } from './scroll-behaviour/scroll-manager.js';
...
setAnimationDelay();
registerOnScrollCallback(setAnimationDelay);
